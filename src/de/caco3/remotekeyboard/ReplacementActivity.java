...
public class ReplacementActivity extends Activity implements
	 ...
	 */
	public static final String DBROW = "de.caco3.remotekeyboard.dbrow";

	/**
	 * for passing in the value of the shortcut field via an intent.
	 */
	public static final String DBKEY = "de.caco3.remotekeyboard.dbkey";

	/**
	 * for passing in the value of the phrase field via an intent.
	 */
	public static final String DBVAL = "de.caco3.remotekeyboard.dbval";
