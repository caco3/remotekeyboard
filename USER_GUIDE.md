...
Open the [Releases](https://github.com/caco3/remotekeyboard/releases), click the latest release, and download the `RemoteKeyboard-v0.4.1.apk` artifact.
...
Transfer `RemoteKeyboard-v0.4.1.apk` to your phone and install it. You must allow installation from unknown sources:
